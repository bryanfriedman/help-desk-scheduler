...
public final class ClassForm extends ActionForm {

   private String[] label = {"", "", "", "", 
                             "", ""};
   public String getLabelIndexed(int index) {
      return (this.label[index]);
   }
   public void setLabelIndexed(int index, String label) {
   ...
   ActionErrors errors = new ActionErrors();
      ...
      for (int i = 0; i < 6; i++) {
         ...
         String rowi = label[i] + startTime[i] + endTime[i] + daysi;
