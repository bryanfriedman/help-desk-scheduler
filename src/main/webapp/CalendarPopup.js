...
function CalendarPopup_getStyles() {
	...
	result += "TD.calday{border:solid thin #C0C0C0;border-width:0 0 1 0;background-color:white}\n";
	result += "TD.calmonth{text-align:right;background-color:white}\n";
	result += "TD.caltoday{text-align:right;color:white;background-color:#C0C0C0;border-width:1;border:solid thing #800000;}\n";
	result += "TD.textlink{border:solid thin #C0C0C0; border-width:1 0 0 0;background-color:white}\n";
	...
	result += "A:hover{text-decoration:underlined;color:dimgray;}\n";
...
function CalendarPopup_getCalendar() {
	...
	if (this.type == "WINDOW") {
		...
		result += '<TABLE WIDTH=144 BORDER=1 BORDERWIDTH=1 style="background-color:white" BORDERCOLOR="#808080" CELLSPACING=0 CELLPADDING=1>\n';
